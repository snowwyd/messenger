...
export default function GroupMembers() {
    return (
        <div>
            <div className={`${styles.block} ${styles.photos}`}>
                <div className={styles.icon}></div>
                <div className={styles.text}>340 photos</div>
            </div>
            <div className={`${styles.block} ${styles.videos}`}>
                <div className={styles.icon}></div>
                <div className={styles.text}>44 videos</div>
            </div>
            <div className={`${styles.block} ${styles.audio}`}>
                <div className={styles.icon}></div>
            ...
            <div className={`${styles.block} ${styles.gifs}`}>
                <div className={styles.icon}></div>
                <div className={styles.text}>139 gifs</div>
            </div>
            <div className={`${styles.block} ${styles.files}`}>
                <div className={styles.icon}></div>
